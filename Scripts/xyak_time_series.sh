...
gmt begin SYBC_plot png
 gmt subplot begin 3x1 -Ff35c/50c -A+o-1c/-1.5c -M1c/2c --FONT_ANNOT_PRIMARY=20p,Helvetica -T"SYBC Station Time Series"
  # plot the north component
  gmt subplot set 0 -A"Reference latitude: 27.81°N"
  gmt basemap -R2011/2017/-7/5 -BWrbt -Bxa0f0+l"Time (Year)" -Bya2f1+l"North (cm)" --FONT_LABEL=30p,Helvetica-Bold
  ...
  gmt plot -W2p,purple << EOF
    ...
    $earthquake_date 1000
EOF
  gmt basemap -R2011-01-01/2018-01-01/-7/5 -f0T -Bxa1Yf1o+l"Time (Year)" -Bya2f1+l"North (cm)" --FONT_LABEL=30p,Helvetica-Bold

  #plot the east component
  gmt subplot set 1 -A"Reference longitude: 85.71@~o@~E"
  gmt basemap -R2011/2017/-12/8 -BWrbt -Bxa0f0+l"Time (Year)" -Bya4f1+l"East (cm)" --FONT_LABEL=30p,Helvetica-Bold
  ...
  gmt plot -W2p,purple << EOF
    ...
    $earthquake_date 1000
EOF
  gmt basemap -R2011-01-01/2018-01-01/-12/8 -f0T -Bxa1Yf1o+l"Time (Year)" -By45f1+l"East (cm)" --FONT_LABEL=30p,Helvetica-Bold

  #plot the vertical component
  gmt subplot set -A"Reference ellipsoid height: 3794.2476 m"
  gmt basemap -R2011/2017/-4/4 -BWrbt -Bxa0f0+l"Time (Year)" -Bya1f1+l"Up (cm)" --FONT_LABEL=30p,Helvetica-Bold
  ...
  gmt plot -W2p,purple << EOF
    ...
    $earthquake_date 1000
EOF
  gmt basemap -R2011-01-01/2018-01-01/-4/4 -f0T -Bxa1Yf1o+l"Time (Year)" -Bya1f1+l"Up (cm)" --FONT_LABEL=30p,Helvetica-Bold
